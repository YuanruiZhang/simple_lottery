...
//set-up
let questionList = ["question1", " Which one is not one of Shakespeare’s plays?", "question3","How many countries are there in the world?","question5"]
let currentQuestion = 0;
let answerList = ["a","Oedipus Rex","c","195","e"];
let timer = null;
let runLottery = true;
